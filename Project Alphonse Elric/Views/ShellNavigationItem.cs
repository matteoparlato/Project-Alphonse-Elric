    ...
    public class ShellNavigationItem : INotifyPropertyChanged
    {
        ...
        public bool IsSelected
        {
            ...
            set
            {
                ...
                SelectedForeground = value ? Application.Current.Resources["SystemControlForegroundAccentBrush"] as SolidColorBrush : GetStandardTextColorBrush();
            }
        }
        ...
        private ShellNavigationItem(string name, char symbolAsChar, Type pageType)
        {
            this.Label = name;
        ...
        public static ShellNavigationItem FromType<T>(string name, char symbolAsChar) where T : Page
        {
            return new ShellNavigationItem(name, symbolAsChar, typeof(T));
        }
